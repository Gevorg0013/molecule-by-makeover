        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_BannerTranslations_Languages_LanguageId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_GalleryImages_Users_UploadedByUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ShippingTotal = table.Column<decimal>(type: "numeric(18,2)", nullable: false),
                    ...
                    ShippingAddress_Phone = table.Column<string>(type: "character varying(30)", maxLength: 30, nullable: false),
                    ...
                    StockReservationExpiresAt = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: true),
                    CreatedAt = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: true)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BlogPostTranslations_Languages_LanguageId",
                        column: x => x.LanguageId,
                        principalTable: "Languages",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BannerTranslations_BannerId_LanguageId",
                table: "BannerTranslations",
                columns: new[] { "BannerId", "LanguageId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_BannerTranslations_LanguageId",
                table: "BannerTranslations",
                column: "LanguageId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BlogPostTranslations_BlogPostId_LanguageId",
                table: "BlogPostTranslations",
                columns: new[] { "BlogPostId", "LanguageId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_BlogPostTranslations_LanguageId",
                table: "BlogPostTranslations",
                column: "LanguageId");

            migrationBuilder.CreateIndex(
                name: "IX_BlogPostTranslations_Slug_LanguageId",
                table: "BlogPostTranslations",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CategoryTranslations_Slug_LanguageId",
                table: "CategoryTranslations",
                columns: new[] { "Slug", "LanguageId" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GalleryImages_UploadedByUserId",
                table: "GalleryImages",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PageTranslations_Slug_LanguageId",
                table: "PageTranslations",
                columns: new[] { "Slug", "LanguageId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_ProcessedPaymentEvents_ProviderKey_EventId",
                table: "ProcessedPaymentEvents",
                columns: new[] { "ProviderKey", "EventId" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductTranslations_Slug_LanguageId",
                table: "ProductTranslations",
                columns: new[] { "Slug", "LanguageId" },
                unique: true);
